...
class API {
  ...
  getEvents() {
    return this._load({url: _const__WEBPACK_IMPORTED_MODULE_1__["URL"].POINTS})
      .then((response) => response.json())
      .then(_models_event__WEBPACK_IMPORTED_MODULE_0__["default"].parseEvents);
  }

  getOffers() {
    return this._load({url: _const__WEBPACK_IMPORTED_MODULE_1__["URL"].OFFERS})
      .then((response) => response.json());
  }

  getDestinations() {
    return this._load({url: _const__WEBPACK_IMPORTED_MODULE_1__["URL"].DESTINATIONS})
      .then((response) => response.json());
  }

  sync(data) {
    return this._load({
      url: `${_const__WEBPACK_IMPORTED_MODULE_1__["URL"].POINTS}/sync`,
      method: Method.POST,
  ...
  updateEvent(id, data) {
    return this._load({
      url: `${_const__WEBPACK_IMPORTED_MODULE_1__["URL"].POINTS}/${id}`,
      method: Method.PUT,
      body: JSON.stringify(data.toRAW()),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then((response) => response.json())
      .then(_models_event__WEBPACK_IMPORTED_MODULE_0__["default"].parseEvent);
  }

  createEvent(event) {
    return this._load({
      url: _const__WEBPACK_IMPORTED_MODULE_1__["URL"].POINTS,
      method: Method.POST,
  ...
  deleteEvent(id) {
    return this._load({url: `${_const__WEBPACK_IMPORTED_MODULE_1__["URL"].POINTS}/${id}`, method: Method.DELETE});
  }
}
...
class Provider {
  ...
  getEvents() {
    ...
    return Promise.resolve(_models_event__WEBPACK_IMPORTED_MODULE_0__["default"].parseEvents(storeItems));
  }
  ...
  getOffers() {
    if (isOnline()) {
      return this._api.getOffers()
        .then((offers) => {
          this._store.setOffers(offers, _const__WEBPACK_IMPORTED_MODULE_2__["URL"].OFFERS);

          return offers;
        });
    }

    return Promise.resolve(this._store.getItems(_const__WEBPACK_IMPORTED_MODULE_2__["URL"].OFFERS));
  }
  ...
  getDestinations() {
    if (isOnline()) {
      return this._api.getDestinations()
        .then((destinations) => {
          this._store.setDestinations(destinations, _const__WEBPACK_IMPORTED_MODULE_2__["URL"].DESTINATIONS);

          return destinations;
        });
    }

    return Promise.resolve(this._store.getItems(_const__WEBPACK_IMPORTED_MODULE_2__["URL"].DESTINATIONS));
  }
  ...
  createEvent(event) {
    ...
    const localNewEvent = _models_event__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(event, {id: localNewEventId}));
  ...
  updateEvent(id, event) {
    ...
    const localItem = _models_event__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(event, {id}));
...
class Controls extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/days-container.js":
/*!******************************************!*\
  !*** ./src/components/days-container.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DaysContainer; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
class DaysContainer extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DaysItem; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
const createTripDayItemMarkup = (it, index) => {
  const getDatetime = `${it ? `${it.year}-${Object(_utils_time__WEBPACK_IMPORTED_MODULE_3__["castTimeFormat"])(_const__WEBPACK_IMPORTED_MODULE_2__["months"].indexOf(it.month) + 1)}-${Object(_utils_time__WEBPACK_IMPORTED_MODULE_3__["castTimeFormat"])(it.day)}` : ``}`;
  return (
...
class DaysItem extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(days) {
    super();
    this._days = days;
  }
...
class Destination extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony import */ var _destination__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./destination */ "./src/components/destination.js");
/* harmony import */ var _offers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./offers */ "./src/components/offers.js");
/* harmony import */ var _utils_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/common */ "./src/utils/common.js");
/* harmony import */ var _utils_time__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/time */ "./src/utils/time.js");
/* harmony import */ var _controllers_event_controller__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../controllers/event-controller */ "./src/controllers/event-controller.js");
...
/* harmony import */ var flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! flatpickr/dist/flatpickr.min.css */ "./node_modules/flatpickr/dist/flatpickr.min.css");
/* harmony import */ var flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_8__);
...
const createTripFormTemplate = (event, isFavorite, newType, city, points, types, mode, price, startDate, endDate, externalData) => {
  ...
  const startTimeForm = Object(_utils_time__WEBPACK_IMPORTED_MODULE_4__["formatTime"])(startDate, true);
  const endTimeForm = Object(_utils_time__WEBPACK_IMPORTED_MODULE_4__["formatTime"])(endDate, true);
  ...
  const isTypeActivity = _const__WEBPACK_IMPORTED_MODULE_6__["typeItemsActivity"].some((it) => newType === it.toLowerCase()) ? `in` : `to`;
  ...
  const transferMarkup = _const__WEBPACK_IMPORTED_MODULE_6__["typeItemsTransfer"].map((it) => createTypeMarkup(it.toLowerCase(), newType)).join(`\n`);
  const activityMarkup = _const__WEBPACK_IMPORTED_MODULE_6__["typeItemsActivity"].map((it) => createTypeMarkup(it.toLowerCase(), newType)).join(`\n`);
    ...
    `<form class="trip-events__item  event  event--edit" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--destination">
            <label class="event__label  event__type-output" for="event-destination-1">
                ${newType ? Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["capitalizeFirstLetter"])(newType) : `Bus to`} ${isTypeActivity}
            </label>
          ...
          <button class="event__reset-btn" type="reset">${mode !== _controllers_event_controller__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING ? `${deleteButtonText}` : `Cancel`}</button>
          ${mode !== _controllers_event_controller__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING ?
      ...
      : ``}
       ...
       <section class="event__details">
        ${typeOffersNew.length ? `${new _offers__WEBPACK_IMPORTED_MODULE_2__["default"](typeOffersNew, offers).getTemplate()}` : ``}
        ${updateDescription.length ? `${new _destination__WEBPACK_IMPORTED_MODULE_1__["default"](updateDescription, updatePhoto).getTemplate()}` : ``}
       </section>
    </form>`
  );
};

class EditForm extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(event, points, types, mode) {
    ...
    this._types = types;
    this._mode = mode;
    this._externalData = _const__WEBPACK_IMPORTED_MODULE_6__["DefaultButtonData"];
  ...
  setData(data) {
    this._externalData = Object.assign({}, _const__WEBPACK_IMPORTED_MODULE_6__["DefaultButtonData"], data);
    this.rerender();
  }
  ...
  _applyFlatpickr() {
    ...
    const self = this;
    this._flatpickrStart = flatpickr__WEBPACK_IMPORTED_MODULE_7___default()((this.getElement().querySelector(`#event-start-time-1`)), {
    ...
    this._flatpickrEnd = flatpickr__WEBPACK_IMPORTED_MODULE_7___default()((this.getElement().querySelector(`#event-end-time-1`)), {
      dateFormat: `d/m/y H:i`,
      enableTime: true,
  ...
  _subscribeOnEvents() {
    ...
    element.querySelector(`#event-start-time-1`).addEventListener(`change`, (evt) => {
      this._startDate = flatpickr__WEBPACK_IMPORTED_MODULE_7___default.a.parseDate(evt.target.value, `d/m/y H:i`);

    });

    element.querySelector(`#event-end-time-1`).addEventListener(`change`, (evt) => {
      this._endDate = flatpickr__WEBPACK_IMPORTED_MODULE_7___default.a.parseDate(evt.target.value, `d/m/y H:i`);
    });
    ...
    destinationInputElement.addEventListener(`change`, (evt) => {
      ...
      if (optionFound) {
        ...
        destinationInputElement.setCustomValidity(_const__WEBPACK_IMPORTED_MODULE_6__["DestinationValidationMessage"].WRONG);
      }
    });

    if (!destinationInputElement.value.length) {
      destinationInputElement.setCustomValidity(_const__WEBPACK_IMPORTED_MODULE_6__["DestinationValidationMessage"].EMPTY);
    }

    element.querySelector(`.event__input--price`).addEventListener(`change`, (evt) => {
      this._price = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["passNumbersFromString"])(evt.target.value);
    });
  }
  ...
  setFavoritesButtonClickHandler(handler) {
    if (this._mode !== _controllers_event_controller__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING) {
...
/*!*********************************!*\
  !*** ./src/components/event.js ***!
  \*********************************/
/*! exports provided: createTripEventOffersMarkup, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createTripEventOffersMarkup", function() { return createTripEventOffersMarkup; });
...
const createTripEventOffersMarkup = (name, price) => {
  return (
...
const createTripEventTemplate = (event) => {
  ...
  const startTime = Object(_utils_time__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(startDate);
  const endTime = Object(_utils_time__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(endDate);
  ...
  const isTypeActivity = _const__WEBPACK_IMPORTED_MODULE_3__["typeItemsActivity"].some((it) => type === it.toLowerCase()) ? `in` : `to`;
  ...
  return (
    `<li class="trip-events__item">
         <div class="event">
           ...
           <h3 class="event__title">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_2__["capitalizeFirstLetter"])(type)} ${isTypeActivity} ${city}</h3>
           ...
           <div class="event__schedule">
             ...
             <p class="event__duration">${Object(_utils_time__WEBPACK_IMPORTED_MODULE_1__["formatTimeDiff"])(timeDiff)}</p>
           </div>
...
class Offers extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class Sorting extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
const timeChart = (timeCtx, data) => {
  const formatter = (val) => `${Object(_utils_time__WEBPACK_IMPORTED_MODULE_4__["formatTimeDiff"])(val)}`;
...
class Statistics extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _getData(cb) {
    const reducer = (sum, event) => {
      ...
      if (cb(event) === true) {
        _const__WEBPACK_IMPORTED_MODULE_3__["typeItemsActivity"].forEach((it) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TotalPrice; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
class TotalPrice extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(sum) {
    super();
    this._sum = sum;
  }
...
class Trail extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/***/ "./src/components/trip-info-container.js":
/*!***********************************************!*\
  !*** ./src/components/trip-info-container.js ***!
  \***********************************************/
/*! exports provided: default */
...
class TripInfoContainer extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return createTripDaysContainerTemplate();
  }
}
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: typeItemsTransfer, typeItemsActivity, months, FilterType, MenuItem, DefaultButtonData, ProcessingButtonData, EventKey, URL, DestinationValidationMessage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "typeItemsTransfer", function() { return typeItemsTransfer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "typeItemsActivity", function() { return typeItemsActivity; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DefaultButtonData", function() { return DefaultButtonData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProcessingButtonData", function() { return ProcessingButtonData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventKey", function() { return EventKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "URL", function() { return URL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DestinationValidationMessage", function() { return DestinationValidationMessage; });
const typeItemsTransfer = [
  `Taxi`,
  `Bus`,
  `Train`,
  `Ship`,
...
const DestinationValidationMessage = {
  ...
  WRONG: `Please select a valid value.`
};
...
/* harmony import */ var _components_event__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/event */ "./src/components/event.js");
/* harmony import */ var _components_edit_form__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/edit-form */ "./src/components/edit-form.js");
/* harmony import */ var _models_event__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/event */ "./src/models/event.js");
...
const EmptyEvent = {
  startDate: flatpickr__WEBPACK_IMPORTED_MODULE_6___default.a.parseDate(new Date(), `d/m/y H:i`),
  endDate: flatpickr__WEBPACK_IMPORTED_MODULE_6___default.a.parseDate(new Date(), `d/m/y H:i`),
  type: `bus`,
  destination: {
    name: ``,
    description: [],
...
const parseFormData = (formData, allOffers, allDestinations) => {
  ...
  const startDate = flatpickr__WEBPACK_IMPORTED_MODULE_6___default.a.parseDate(formData.get(`event-start-time`), `d/m/y H:i`);
  const endDate = flatpickr__WEBPACK_IMPORTED_MODULE_6___default.a.parseDate(formData.get(`event-end-time`), `d/m/y H:i`);
  ...
  return new _models_event__WEBPACK_IMPORTED_MODULE_2__["default"]({
    "type": type,
...
class EventController {
  ...
  render(event, mode) {
    ...
    this._mode = mode;
    this._eventComponent = new _components_event__WEBPACK_IMPORTED_MODULE_0__["default"](event);
    this._eventEditComponent = new _components_edit_form__WEBPACK_IMPORTED_MODULE_1__["default"](event, this._points, this._types, this._mode);
    ...
    this._eventEditComponent.setFavoritesButtonClickHandler((isFavorite) => {
      const data = _models_event__WEBPACK_IMPORTED_MODULE_2__["default"].clone(event);
    ...
    this._eventEditComponent.setSubmitHandler((evt, id) => {
      ...
      this._eventEditComponent.setData({
        SAVE_BUTTON_TEXT: _const__WEBPACK_IMPORTED_MODULE_4__["ProcessingButtonData"].SAVE_BUTTON_TEXT
      });
      Object(_utils_common__WEBPACK_IMPORTED_MODULE_5__["switchFormAvailability"])(this._eventEditComponent.getElement(), true);
    ...
    this._eventEditComponent.setDeleteButtonClickHandler(() => {
      if (this._mode !== Mode.ADDING) {
        this._eventEditComponent.setData({
          DELETE_BUTTON_TEXT: _const__WEBPACK_IMPORTED_MODULE_4__["ProcessingButtonData"].DELETE_BUTTON_TEXT,
        });
        Object(_utils_common__WEBPACK_IMPORTED_MODULE_5__["switchFormAvailability"])(this._eventEditComponent.getElement(), true);
    ...
    switch (mode) {
      case Mode.DEFAULT:
        ...
        if (oldEventEditComponent && oldEventComponent) {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventComponent, oldEventComponent);
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventEditComponent, oldEventEditComponent);
          this._replaceEditToEvent();
        } else {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._eventComponent);
        }
        break;
      case Mode.ADDING:
        this._createButton.disabled = true;
        if (oldEventEditComponent && oldEventComponent) {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldEventComponent);
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldEventEditComponent);
        }
        document.addEventListener(`keydown`, this._onEscKeyDown);
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._eventEditComponent, _utils_render__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTERBEGIN);
        break;
    }
  ...
  setDefaultView() {
    if (this._mode === Mode.EDIT) {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._eventEditComponent);
    }
  }

  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._eventEditComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._eventComponent);
    document.removeEventListener(`keydown`, this._onEscKeyDown);
  }
  ...
  shake() {
    ...
    setTimeout(() => {
      ...
      this._eventEditComponent.setData(_const__WEBPACK_IMPORTED_MODULE_4__["DefaultButtonData"]);
  ...
  _replaceEditToEvent() {
    ...
    if (document.contains(this._eventEditComponent.getElement())) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventComponent, this._eventEditComponent);
    }
  ...
  _replaceEventToEdit() {
    this._onViewChange();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventEditComponent, this._eventComponent);
    this._mode = Mode.EDIT;
    this._createButton.disabled = false;
  }

  _onEscKeyDown(evt) {
    const isEscKey = evt.key === _const__WEBPACK_IMPORTED_MODULE_4__["EventKey"].ENTER_KEY || evt.key === _const__WEBPACK_IMPORTED_MODULE_4__["EventKey"].ESC_KEY;
...
class FilterController {
  constructor(container, eventsModel) {
    ...
    this._activeFilterType = _const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING;
  ...
  render() {
    ...
    Object.values(_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"]).map((filterType) => {
    ...
    if (oldComponent) {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(container, this._filterComponent);
    }
  }

  setDefaultFilter() {
    this._eventsModel.setFilter(_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING);
    this._filterComponent.setActiveItem(_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING);
  }
  ...
  _onFilterChange(filterType) {
    switch (filterType) {
      case _const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING:
...
/***/ "./src/controllers/total-price-controller.js":
/*!***************************************************!*\
  !*** ./src/controllers/total-price-controller.js ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TotalPriceController; });
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _components_total_price__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/total-price */ "./src/components/total-price.js");
/* harmony import */ var _utils_trail_info__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/trail-info */ "./src/utils/trail-info.js");




class TotalPriceController {
  constructor(container, eventsModel) {
    this._container = container;
    this._eventsModel = eventsModel;
  ...
  render() {
    ...
    const totalPrice = Object(_utils_trail_info__WEBPACK_IMPORTED_MODULE_2__["getTotalPrice"])(events);

    this._totalPriceComponent = new _components_total_price__WEBPACK_IMPORTED_MODULE_1__["default"](totalPrice);

    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._totalPriceComponent, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._totalPriceComponent);
    }
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TrailController; });
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _components_trail__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/trail */ "./src/components/trail.js");
/* harmony import */ var _utils_trail_info__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/trail-info */ "./src/utils/trail-info.js");
/* harmony import */ var _utils_time__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/time */ "./src/utils/time.js");
...
class TrailController {
  ...
  render() {
    ...
    const trail = Object(_utils_trail_info__WEBPACK_IMPORTED_MODULE_2__["getTrail"])(events);
    const trailDates = Object(_utils_time__WEBPACK_IMPORTED_MODULE_3__["getNoRepeatingDates"])(events);

    this._trailComponent = new _components_trail__WEBPACK_IMPORTED_MODULE_1__["default"](trail, trailDates);

    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._trailComponent, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._trailComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
    }
  }
...
/* harmony import */ var _components_no_events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/no-events */ "./src/components/no-events.js");
...
/* harmony import */ var _components_days_container__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/days-container */ "./src/components/days-container.js");
/* harmony import */ var _components_days_item__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/days-item */ "./src/components/days-item.js");
...
const getSortedEvents = (events, sortType) => {
  ...
  switch (sortType) {
    case _components_sorting__WEBPACK_IMPORTED_MODULE_2__["SortType"].PRICE:
      showingEvents.sort((a, b) => b.price - a.price);
      break;
    case _components_sorting__WEBPACK_IMPORTED_MODULE_2__["SortType"].TIME:
...
const getDaysContainer = (container, dates = ``) => {
  container.innerHTML = ``;
  const daysItem = new _components_days_item__WEBPACK_IMPORTED_MODULE_4__["default"](dates);
  if (dates === ``) {
    daysItem.getElement().querySelector(`.day__info`).innerHTML = ``;
  }
  Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["render"])(container, daysItem);
...
const renderEvents = (events, container, onDataChange, onViewChange, points, types) => {
  return events.map((event) => {
    ...
    eventController.render(event, _event_controller__WEBPACK_IMPORTED_MODULE_0__["Mode"].DEFAULT);
...
class TripController {
  constructor(container, eventsModel, filterController, api) {
    ...
    this._noEventsComponent = new _components_no_events__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._sortingComponent = new _components_sorting__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._tripDaysContainer = new _components_days_container__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._creatingEvent = null;
    this._sortType = _components_sorting__WEBPACK_IMPORTED_MODULE_2__["SortType"].EVENT;
    this._createButton = document.querySelector(`.trip-main__event-add-btn`);
  ...
  render(points, types) {
    ...
    this._points = points;
    this._types = types;
    this._trailDates = Object(_utils_time__WEBPACK_IMPORTED_MODULE_6__["getNoRepeatingDates"])(events);
    if (!events.length) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._noEventsComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._sortingComponent);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._tripDaysContainer);
  ...
  createEvent() {
    ...
    const tripDaysElement = this._tripDaysContainer.getElement();
    this._creatingEvent = new _event_controller__WEBPACK_IMPORTED_MODULE_0__["default"](tripDaysElement, this._onDataChange, this._onViewChange, this._points, this._types);
    ...
    this._creatingEvent.render(_event_controller__WEBPACK_IMPORTED_MODULE_0__["EmptyEvent"], _event_controller__WEBPACK_IMPORTED_MODULE_0__["Mode"].ADDING);
    this._creatingEvent = null;
  }
  ...
  _updateEvents() {
    ...
    if (!this._eventsModel.getEvents(_const__WEBPACK_IMPORTED_MODULE_7__["FilterType"].EVERYTHING).length) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container, this._noEventsComponent);
    }
  }

  _onSortTypeChange(sortType) {
    const trailDates = Object(_utils_time__WEBPACK_IMPORTED_MODULE_6__["getNoRepeatingDates"])(this._eventsModel.getEvents());
    ...
    if (sortType !== _components_sorting__WEBPACK_IMPORTED_MODULE_2__["SortType"].EVENT) {
  ...
  _onDataChange(oldData, newData, isFavoriteUpdate = false) {
    ...
    if (oldData === _event_controller__WEBPACK_IMPORTED_MODULE_0__["EmptyEvent"]) {
      this._creatingEvent = null;
      if (newData === null) {
        ...
        this._api.createEvent(newData)
          .then((eventModel) => {
            ...
            eventController.render(eventModel, _event_controller__WEBPACK_IMPORTED_MODULE_0__["Mode"].DEFAULT);
  ...
  _onFilterChange() {
    this._sortingComponent.setActiveItem(_components_sorting__WEBPACK_IMPORTED_MODULE_2__["SortType"].EVENT);
    this._sortType = _components_sorting__WEBPACK_IMPORTED_MODULE_2__["SortType"].EVENT;
    this._updateEvents();
  }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _controllers_total_price_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controllers/total-price-controller */ "./src/controllers/total-price-controller.js");
/* harmony import */ var _controllers_trail_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./controllers/trail-controller */ "./src/controllers/trail-controller.js");
...
/* harmony import */ var _controllers_filter_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controllers/filter-controller */ "./src/controllers/filter-controller.js");
/* harmony import */ var _components_trip_info_container__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/trip-info-container */ "./src/components/trip-info-container.js");
/* harmony import */ var _controllers_trip_controller__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controllers/trip-controller */ "./src/controllers/trip-controller.js");
/* harmony import */ var _models_events__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models/events */ "./src/models/events.js");
...
/* harmony import */ var _api_store_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./api/store.js */ "./src/api/store.js");
...
const api = new _api_api_js__WEBPACK_IMPORTED_MODULE_9__["default"](AUTHORIZATION, END_POINT);
const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_11__["default"](STORE_NAME, window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_10__["default"](api, store);
const eventsModel = new _models_events__WEBPACK_IMPORTED_MODULE_6__["default"]();
const tripControlsComponent = new _components_controls__WEBPACK_IMPORTED_MODULE_2__["default"]();
const filterController = new _controllers_filter_controller__WEBPACK_IMPORTED_MODULE_3__["default"](tripMainControlsElement, eventsModel);
const loadingComponent = new _components_loading__WEBPACK_IMPORTED_MODULE_8__["default"]();
const trip = new _controllers_trip_controller__WEBPACK_IMPORTED_MODULE_5__["default"](tripEventsElement, eventsModel, filterController, apiWithProvider);
const statisticsComponent = new _components_statistics__WEBPACK_IMPORTED_MODULE_7__["default"](eventsModel);

const tripInfoContainer = new _components_trip_info_container__WEBPACK_IMPORTED_MODULE_4__["default"]();
Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["render"])(tripMainElement, tripInfoContainer, _utils_render__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].AFTERBEGIN);

const tripMainInfoElement = document.querySelector(`.trip-main__trip-info`);
const trailController = new _controllers_trail_controller__WEBPACK_IMPORTED_MODULE_1__["default"](tripMainInfoElement, eventsModel);
const totalPriceController = new _controllers_total_price_controller__WEBPACK_IMPORTED_MODULE_0__["default"](tripMainInfoElement, eventsModel);
trailController.render();
totalPriceController.render();


Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["render"])(tripMainControlsHeader, tripControlsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].AFTEREND);
filterController.render();
Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["render"])(tripEventsElement, loadingComponent);
Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["render"])(pageBodyContainer, statisticsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);
statisticsComponent.hide();

tripControlsComponent.setModeChangeHandler((menuItem) => {
  eventsModel.setFilter(_const__WEBPACK_IMPORTED_MODULE_13__["FilterType"].EVERYTHING);
      ...
      .then((offers) => {
        ...
        apiWithProvider.getDestinations()
          .then((result) => {
            ...
            Object(_utils_render__WEBPACK_IMPORTED_MODULE_12__["remove"])(loadingComponent);
          });
      });
  });
...
class Events {
  ...
  getEvents(filterType = this._activeFilterType) {
    return Object(_utils_filter__WEBPACK_IMPORTED_MODULE_0__["getEventsByFilter"])(this._events, filterType);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: passNumbersFromString, capitalizeFirstLetter, switchFormAvailability */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "passNumbersFromString", function() { return passNumbersFromString; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "capitalizeFirstLetter", function() { return capitalizeFirstLetter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "switchFormAvailability", function() { return switchFormAvailability; });
const passNumbersFromString = (str) => {
...
const switchFormAvailability = (form, disableFlag) => {
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: isPastDate, isFutureDate, isOneDay, getFilteredEvents, getEventsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isPastDate", function() { return isPastDate; });
...
const isPastDate = (dueDate, date) => {
  return dueDate < date && !isOneDay(date, dueDate);
};

const isFutureDate = (dueDate, date) => {
  return dueDate > date && !isOneDay(date, dueDate);
};

const isOneDay = (dateA, dateB) => {
  const a = moment__WEBPACK_IMPORTED_MODULE_1___default()(dateA);
  const b = moment__WEBPACK_IMPORTED_MODULE_1___default()(dateB);
  return a.diff(b, `days`) === 0 && dateA.getDate() === dateB.getDate();
};

const getFilteredEvents = (events, date, filterType) => {
  return events.filter((event) => {
    ...
    return filterType === _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].PAST ? isPastDate(dueDate, date) : isFutureDate(dueDate, date);
  });
};
...
const getEventsByFilter = (events, filterType) => {
  ...
  switch (filterType) {
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].EVERYTHING:
      return events;
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].PAST:
      return getFilteredEvents(events, nowDate, filterType);
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FUTURE:
      return getFilteredEvents(events, nowDate, filterType);
  }
...
/*!***************************!*\
  !*** ./src/utils/time.js ***!
  \***************************/
/*! exports provided: castTimeFormat, formatTime, formatTimeDiff, getNoRepeatingDates */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getNoRepeatingDates", function() { return getNoRepeatingDates; });
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const */ "./src/const.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_1__);
...
const formatTime = (date, forForm = false) => {
  return forForm ? moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`YYYY-MM-DDThh:mm`) : moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`HH:mm`);
};

const formatTimeDiff = (timeDiff) => {
  const duration = moment__WEBPACK_IMPORTED_MODULE_1___default.a.duration(timeDiff);
...
const getNoRepeatingDates = (events) => {
  const set = new Set();
  events.forEach((evt) => set.add(JSON.stringify({year: evt.startDate.getFullYear(), day: evt.startDate.getDate(), month: _const__WEBPACK_IMPORTED_MODULE_0__["months"][evt.startDate.getMonth()]})));
...
/***/ "./src/utils/trail-info.js":
/*!*********************************!*\
  !*** ./src/utils/trail-info.js ***!
  \*********************************/
/*! exports provided: getTotalPrice, getTrail */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
