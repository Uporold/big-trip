...
const createTripFormEventDetailsContainerTemplate = () => {
  return (
    `<section class="event__details"></section>`
  );
};

const createTripFormEventOffersTemplate = () => {
  return (
...
const createTripFormEventDestinationTemplate = () => {
  return (
...
const tripEventsHeader = tripEventsElement.querySelector(`.visually-hidden`);
render(tripEventsHeader, createTripSortingTemplate(), `afterend`);
